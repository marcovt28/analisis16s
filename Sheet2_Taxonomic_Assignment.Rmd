...
```{r, include = FALSE} 
seqtab <- readRDS("/home/user19/analisis16s/objects/Sheet1/seqtab.rds") 
...
```{r, include = FALSE}
taxa <- assignTaxonomy(seqtab.nochim, "/home/analisis16s/silva_database/silva_nr99_v138.1_train_set.fa.gz", multithread=TRUE)
taxa <- addSpecies(taxa, "/home/analisis16s/silva_database/silva_species_assignment_v138.1.fa.gz")
...
alignment <- readRDS("/home/user19/analisis16s/objects/Sheet2/alignment.rds")
alignment
options(Biostrings.coloring = TRUE) #para ver con color
alignment

phangAlign <- phyDat(as(alignment, "matrix"), type="DNA")
phangAlign<- readRDS("/home/user19/analisis16s/objects/Sheet2/phangAlign.rds")

#dm <- dist.ml(phangAlign)
#treeNJ <- NJ(dm)
treeNJ <- readRDS("/home/user19/analisis16s/objects/Sheet2/treeNJ.rds")

fit <- pml(treeNJ, data=phangAlign)
fit<- readRDS("/home/user19/analisis16s/objects/Sheet2/fit.rds")
