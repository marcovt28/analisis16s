...
```{r}
miseq_path = "/home/user19/analisis16s/data/Demultiplexed"
...
#errF <- saveRDS(errF, "/home/user19/analisis16s/errF.rds")
errF <- readRDS("/home/user19/analisis16s/objects/Sheet1/errF.rds")

#errR <- learnErrors(filtRs, multithread=TRUE)
#errR <- saveRDS(errF, "/home/user19/analisis16s/errR.rds")
errR <- readRDS("/home/user19/analisis16s/objects/Sheet1/errR.rds")
```
