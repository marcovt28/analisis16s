...
```{r}
obj <- psd5
t(otu_table(obj)) -> otu_table(obj) #creates a transposable matrix
...
```
#Up to here, we are just preparing the data...
...
diagdds = estimateSizeFactors(diagdds, geoMeans = geoMeans) #New object for deseq2 analysis
